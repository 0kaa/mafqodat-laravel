                                ...
                                <div class="card-body">
                                    <form class="form form-vertical" id="create_station_form"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="details-vertical">{{ __('station_details') }}</label>
                                                    <input type="text" id="details-vertical" class="form-control"
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="number-vertical">{{ __('station_number') }}</label>
                                                    <input type="text" id="number-vertical" class="form-control"
