                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ __('edit_country') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ __('edit_country') }} | {{ $country->name }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" id="country_form" action="{{ route('admin.countries.update' ,$country->id ) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-vertical" class="form-control" name="name_ar" value="{{ old('name_ar', $country->name_ar) }}" placeholder="{{ __('write_name_ar') }}" />
                                                    @error('name_ar')
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-vertical" class="form-control" name="name_en" value="{{ old('name_en', $country->name_en) }}" placeholder="{{ __('write_name_en') }}" />
                                                    @error('name_en')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
